...
│   ~/code/web
│   └ vite │
└──────────┘ 1/2 ▸ ~/code/gen/ricon  ⎇ main  ✳ claude-opus-5 93k/1M  ⧉ copy ✓ v0.4.2
```
